...
[rewrite_local]
^https?:\/\/buy\.itunes\.apple\.com\/verifyReceipt$ url script-response-body https://raw.githubusercontent.com/loganteo/qx-configs/master/configs/scripts/APPheji_iTunes.js
...
*/
var result = {};
var altResult = JSON.parse(typeof $response != "undefined" && $response.body || null);
var headers = {};
...
var uaProductMapping = {
  'Bear': {product_id: 'net.shinyfrog.bear_iOS.pro_yearly_subscription_bis'},
};
var receipt = {
  "quantity": "1",
  ...
  "product_id": "https://t.me/loganteo",
...
var renewal = {
  ...
  "auto_renew_product_id": "https://t.me/loganteo",
  "original_transaction_id": "666666666666666",
  "auto_renew_status": "0"
}
for (var uaKey in uaProductMapping) {
  if (UA && UA.includes(uaKey)) {
    ...
    altResult.receipt.in_app = [receipt];
    altResult.latest_receipt_info = [receipt];
